export default function Topbar({ title = "Dashboard", subtitle = "Welcome back" }) {
  return (
    <header className="flex items-center justify-between px-6 py-3 bg-white border-b border-gray-100 flex-shrink-0">
      ...
      {/* Right side — wire up notifications & user menu yourself */}
      <div className="flex items-center gap-3">
        ...
        {/* Avatar */}
        <div className="w-8 h-8 rounded-full bg-green-600 flex items-center justify-center text-white text-xs font-medium cursor-pointer">
          JD
        </div>
      </div>
    </header>
